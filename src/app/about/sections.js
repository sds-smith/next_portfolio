...
const copy1 = [
    ...
    "I believe in first listening to understand needs, perspectives, and obstacles, then formulating a response to meet those needs, overcome the obstacles and honor perspectives.", 
    "Software is foremost about people - the people who use it and the people who develop and maintain it. As a Software Engineer, I put people first, crafting solutions around their needs, choosing technologies that fit the solution.",
...
const copy2 = [
    ["In my current role, I work as part of a distributed team for a small Federal contractor. In this role, I've had the opportunity to work in an Agile project environment and on three distinct projects.",
    ...
    "Currently, I am creating from scratch a proof-of-concept SPFx app with React frontend intended to replace a legacy application which was written in vanilla JavaScript with jQuery."].join(' '),
