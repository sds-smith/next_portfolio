...
const copy1 = [
    ...
    "I believe it's our job as developers to produce real and measurable results for business owners, while also leaving a codebase for fellow and future developers that is clean, maintainable, and extensible. There is nothing more important for the legacy of a codebase than clean code/ clean architecture, but it means nothing if it doesn't produce real value for the customer right now.",
...
const copy2 = [
    ...
    "In addition to code review and pair programming, I've had the opportunity to make technical and architectural decisions, prepare technical documentation, establish and maintain production, stage, and test environments as well as CI/CD pipeline, and help fellow developers on their own journey to become better developers.",
    ...
    ["Three years ago, I ventured into the gig economy as a freelance developer. The hallmark of this effort was the delivery of an MVP to a client which is currently hosted on the public internet as a subscription-based productivity application.",
...
const copy3 = [
  "Software development is Act II of my career journey. Act I was a dynamic and fulfilling career in the Food and Hospitality industry. Serving in leadership roles of progressively increasing scopes of influence and responsibility, I spent my final ten years overseeing an organization of six locations, 26 managers, and more than 300 front-line team members.",
  "This was a people role in a people business. Software, too, is a people business. Software is for people -- the people who use it, and the people who develop and maintain it. I believe the skills and qualities of character that make a successful leader in the restaurant world are infinitely transferrable; skills like partnering, mentoring, and listening; and qualities like humility, vision, and empathy."
]
